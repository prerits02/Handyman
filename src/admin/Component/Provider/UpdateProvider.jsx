    ...
    <>
        <View style={styles.head}>
            <View style={{flexDirection:"row", alignItems:"center"}}>
                ...
                <Text style={styles.heading}>Update Provider</Text>
            </View>
            <Popover
                        from={(
                            <TouchableOpacity>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.btnContainer}>
                    <TouchableOpacity style={styles.btn}>
                        <FontAwesome6 name="money-bills" size={22}/>
                        <Text style={styles.btntxt}>Payout List</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.btn}>
                        <FontAwesome name="building" size={22}/>
                        <Text style={styles.btntxt}>Service Address</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.btn}>
                        <MaterialIcons name="edit-document" size={22}/>
                        <Text style={styles.btntxt}>Documents</Text>
                    </TouchableOpacity>
                </View>
