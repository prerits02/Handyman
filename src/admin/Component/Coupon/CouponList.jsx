...
const CouponList = () => {
    ...
    const data = [
        {id:1,type:"HE45TYU",status:"ACTIVE",Dicount:"$8",Date:"28 Sep, 2022"},
        {id:2,type:"123",status:"INACTIVE",Dicount:"10%",Date:"28 Sep, 2022"},
    ]
                ...
                return(
                    <View style={styles.cardContainer} key={item.id}>
                        <View style={styles.flexrow}>
                            ...
                            <View>
                                <Text style={styles.dataheading}>Coupon Code</Text>
                        ...
                        <View style={[styles.flexrow,{justifyContent:"space-between"}]}>
                            <View style={styles.flexrow}>
                                ...
                                <View>
                                    <Text style={styles.dataheading}>Discount</Text>
                                        <Text style={styles.data}>{item.Dicount}</Text>
                                </View>
                            </View>
                            <View style={[styles.flexrow,{marginRight:20}]}>
                                <EvilIcons name="calendar" size={28} color="#f1b407"/>
                                <View>
                                    <Text style={styles.dataheading}>Exp. Date</Text>
