...
const BeauryPersonalCare = () => {
  return (
    <View>
      <Text style={{color:"#3b3b3b",fontSize:17,fontWeight:"700",marginHorizontal:10}}>Beauty & Personal Care</Text>
...
export default BeauryPersonalCare
